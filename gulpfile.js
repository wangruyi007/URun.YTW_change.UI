...
gulp.task('server', function() {
    runSequence('build', 'watch', function(){
        ...
        browserSync.init({
            ...
            port: 8765,
            startPath: "./html/pretrialPicture.html",
            open: "external"
        },function(){
...
gulp.task('watch', () => {
    gulp.watch(['./app/html/*.html','./app/*.json','./app/templates/**'], ['buildhtml']);
...
gulp.task('copy', function(){
    ...
    gulp.src([
        './app/libs/multsel/**',
        '!./app/libs/multsel/js/npm.js'
    ])
        .pipe(gulp.dest('./dist/libs/multsel'));
    gulp.src([
        './app/libs/nicescroll/**',
        '!./app/libs/nicescroll/js/npm.js'
    ])
        .pipe(gulp.dest('./dist/libs/nicescroll'));
    gulp.src([
        './app/libs/utf8-net/**',
        '!./app/libs/utf8-net/js/npm.js'
    ])
